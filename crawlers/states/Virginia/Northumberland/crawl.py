...
class NorthumberlandCountyCrawler(TableCrawler):
    def __init__(self):
        super().__init__(
            url="https://www.co.northumberland.va.us/meetings?date_filter%5Bvalue%5D%5Bmonth%5D=1&"
            ...
            "date_filter_1%5Bvalue%5D%5Byear%5D=2027&field_microsite_tid_1=28",
...
if __name__ == "__main__":
    ...
    async def main():
        crawler = NorthumberlandCountyCrawler()
        await crawler.crawl()
