...
class GoochlandCounty(TableCrawler):
    def __init__(self):
        super().__init__(
            url="https://goochlandcountyva.iqm2.com/Citizens/"
            "Calendar.aspx?From=1%2f1%2f2021&To=12%2f31%2f9999",
